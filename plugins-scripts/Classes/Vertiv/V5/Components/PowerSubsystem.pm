package Classes::Vertiv::V5::Components::PowerSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('VERTIV-V5-MIB', [
    ...
    ['totals', 'pduMainTable', 'Classes::Vertiv::V5::Components::PowerSubsystem::Totals'],
    ['phases', 'pduPhaseTable', 'Classes::Vertiv::V5::Components::PowerSubsystem::Phase'],
    ['breakers', 'pduBreakerTable', 'Classes::Vertiv::V5::Components::PowerSubsystem::Breaker'],
    ['outletswitches', 'pduOutletSwitchTable', 'Classes::Vertiv::V5::Components::PowerSubsystem::OutletSwitch'],
    ['outletmeters', 'pduOutletMeterTable', 'Classes::Vertiv::V5::Components::PowerSubsystem::OutletMeter'],
    ['transfers', 'pduTransferTable', 'Classes::Vertiv::V5::Components::PowerSubsystem::Transfer'],
  ]);
}
...
package Classes::Vertiv::V5::Components::PowerSubsystem::Totals;
...
package Classes::Vertiv::V5::Components::PowerSubsystem::Phase;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::Vertiv::V5::Components::PowerSubsystem::Breaker;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::Vertiv::V5::Components::PowerSubsystem::OutletSwitch;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::Vertiv::V5::Components::PowerSubsystem::OutletMeter;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::Vertiv::V5::Components::PowerSubsystem::Transfer;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
