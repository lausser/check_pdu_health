package Classes::Sentry4::Components::PowerSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('Sentry4-MIB', [
    ...
    ['unitmonitors', 'st4UnitMonitorTable', 'Classes::Sentry4::Components::PowerSubsystem::Unit'],
    ...
    ['cordmonitors', 'st4InputCordMonitorTable', 'Classes::Sentry4::Components::PowerSubsystem::InputCord'],
    ...
    ['linemonitors', 'st4LineMonitorTable', 'Classes::Sentry4::Components::PowerSubsystem::Line'],
    ...
    ['phasemonitors', 'st4PhaseMonitorTable', 'Classes::Sentry4::Components::PowerSubsystem::Phase'],
    ...
    ['ocpmonitors', 'st4OcpMonitorTable', 'Classes::Sentry4::Components::PowerSubsystem::OCP'],
    ...
    ['branchmonitors', 'st4BranchMonitorTable', 'Classes::Sentry4::Components::PowerSubsystem::Branch'],
    ...
    ['outletmonitors', 'st4OutletMonitorTable', 'Classes::Sentry4::Components::PowerSubsystem::Outlet'],
...
package Classes::Sentry4::Components::PowerSubsystem::Unit;
...
package Classes::Sentry4::Components::PowerSubsystem::InputCord;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::Sentry4::Components::PowerSubsystem::Line;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::Sentry4::Components::PowerSubsystem::Phase;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);


package Classes::Sentry4::Components::PowerSubsystem::OCP;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::Sentry4::Components::PowerSubsystem::Branch;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package Classes::Sentry4::Components::PowerSubsystem::Outlet;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
