package Classes::Liebert::Components::PowerSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('LIEBERT-GP-PDU-MIB', [
    ['pdus', 'lgpPduTable', 'Classes::Liebert::Components::PowerSubsystem::PDU'],
    ['powersources', 'lgpPduPsTable', 'Classes::Liebert::Components::PowerSubsystem::Powersource'],
  ]);
...
package Classes::Liebert::Components::PowerSubsystem::PDU;
...
package Classes::Liebert::Components::PowerSubsystem::Powersource;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
