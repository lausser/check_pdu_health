package CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('Sentry4-MIB', [
    ...
    ['unitmonitors', 'st4UnitMonitorTable', 'CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::Unit'],
    ...
    ['tempsensormonitors', 'st4TempSensorMonitorTable', 'CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::TempSensor', sub { my $o = shift; $o->{st4TempSensorValue} != -41 && $o->{st4TempSensorStatus} ne 'notFound'}],
    ...
    ['humidsensormonitors', 'st4HumidSensorMonitorTable', 'CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::HumidSensor', sub { my $o = shift; $o->{st4HumidSensorValue} != -1 && $o->{st4HumidSensorStatus} ne 'notFound'}],
    ...
    ['watersensormonitors', 'st4WaterSensorMonitorTable', 'CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::WaterSensor'],
    ...
    ['ccsensormonitors', 'st4CcSensorMonitorTable', 'CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::CcSensor'],
    ...
    ['adcsensormonitors', 'st4DcSensorMonitorTable', 'CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::AdcSensor'],
...
package CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::Unit;
...
package CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::Sensor;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::TempSensor;
our @ISA = qw(CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::Sensor);
...
package CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::HumidSensor;
our @ISA = qw(CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::Sensor);
...
package CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::WaterSensor;
our @ISA = qw(CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::Sensor);
...
package CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::CcSensor;
our @ISA = qw(CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::Sensor);
...
package CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::AdcSensor;
our @ISA = qw(CheckPduHealth::Sentry4::Components::EnvironmentalSubsystem::Sensor);
