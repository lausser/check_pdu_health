package CheckPduHealth::Liebert::Components::EnvironmentalSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('LIEBERT-GP-PDU-MIB', [
    ['measurements', 'lgpPduAuxMeasTable', 'CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::Measurement'],
  ]);
}


package CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::Measurement;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);

sub finish {
  my ($self) = @_;
  bless $self, 'CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::MeasurementTemperature'
      if $self->{lgpPduAuxMeasType} eq 'temperature';
  bless $self, 'CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::MeasurementHumidity'
      if $self->{lgpPduAuxMeasType} eq 'humidity';
  bless $self, 'CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::MeasurementDoorclosure'
      if $self->{lgpPduAuxMeasType} eq 'door-closure';
  bless $self, 'CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::MeasurementContactclosure'
      if $self->{lgpPduAuxMeasType} eq 'contact-closure';
  $self->finish() if ref($self) ne 'CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::Measurement';
}


package CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::MeasurementTemperature;
our @ISA = qw(CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::Measurement);
...
package CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::MeasurementHumidity;
our @ISA = qw(CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::Measurement);
...
package CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::MeasurementDoorclosure;
our @ISA = qw(CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::Measurement);
...
package CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::MeasurementContactclosure;
our @ISA = qw(CheckPduHealth::Liebert::Components::EnvironmentalSubsystem::Measurement);
