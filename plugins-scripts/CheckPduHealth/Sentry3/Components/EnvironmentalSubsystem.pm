package CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('Sentry3-MIB', [
    ['envmons', 'envMonTable', 'CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem::EnvMon'],
    ['temphumidsensors', 'tempHumidSensorTable', 'CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem::TempHumidSensor', sub { my $o = shift; $o->{tempHumidSensorStatus} ne 'notFound'}],
    ['contacts', 'contactClosureTable', 'CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem::Closure'],

    ###['branches', 'branchTable', 'Monitoring::GLPlugin::SNMP::TableItem'],
    ['towers', 'towerTable', 'CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem::Tower'],
...
package CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem::Tower;
...
package CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem::EnvMon;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem::Closure;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package CheckPduHealth::Sentry3::Components::EnvironmentalSubsystem::TempHumidSensor;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
