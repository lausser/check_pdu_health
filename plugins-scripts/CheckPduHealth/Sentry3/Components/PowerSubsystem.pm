package CheckPduHealth::Sentry3::Components::PowerSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('Sentry3-MIB', [
    ['towers', 'towerTable', 'CheckPduHealth::Sentry3::Components::PowerSubsystem::Tower'],
    ['infeeds', 'infeedTable', 'CheckPduHealth::Sentry3::Components::PowerSubsystem::Infeed'],
    ['outlets', 'outletTable', 'CheckPduHealth::Sentry3::Components::PowerSubsystem::Outlet'],
    ['branches', 'branchTable', 'CheckPduHealth::Sentry3::Components::PowerSubsystem::Branch'],
  ]);
...
package CheckPduHealth::Sentry3::Components::PowerSubsystem::Tower;
...
package CheckPduHealth::Sentry3::Components::PowerSubsystem::Infeed;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package CheckPduHealth::Sentry3::Components::PowerSubsystem::Outlet;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
...
package CheckPduHealth::Sentry3::Components::PowerSubsystem::Branch;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
