package CheckPduHealth::HWG::Damocles::Components::SensorSubsystem;
...
sub init {
  ...
  $self->get_snmp_tables('DAMOCLES-MIB', [
      ['sensors', 'sensTable', 'CheckPduHealth::HWG::Damocles::Components::SensorSubsystem::Sensor'],
      ['sensorsetups', 'sensSetupTable', 'CheckPduHealth::HWG::Damocles::Components::SensorSubsystem::SensorSetup'],
  ]);
...
package CheckPduHealth::HWG::Damocles::Components::SensorSubsystem::Sensor;
...
package CheckPduHealth::HWG::Damocles::Components::SensorSubsystem::SensorSetup;
our @ISA = qw(Monitoring::GLPlugin::SNMP::TableItem);
